...
public class SKToolsLogicManager implements SKMapSurfaceListener, SKNavigationListener, SKRouteListener,
     ...
     * @param mapView
     */
    protected void calculateRoute(SKToolsNavigationConfiguration configuration, SKMapSurfaceView mapView) {
        ...
        if (configuration.isAutomaticDayNight()) {
    ...
    protected void stopNavigation() {
        ...
        mapView.setMapSurfaceListener(previousMapSurfaceListener);
